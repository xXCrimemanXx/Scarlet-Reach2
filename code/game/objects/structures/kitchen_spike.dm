...
/obj/structure/kitchenspike/proc/release_mob(mob/living/released)
	var/matrix/m180 = matrix(released.transform)
	m180.Turn(180)
	animate(released, transform = m180, time = 3)
	released.pixel_y = released.get_standard_pixel_y_offset(180)
