...
//Fae need to be restricted pretty specifically and that means making up some wack ass categories lol
#define RACES_FAE \
	/datum/species/faekin,\
...
#define RACES_ALL_PLUS_FAE list(RACES_NOBILITY_ELIGIBLE, RACES_CHURCH_FAVORED, RACES_APPOINTED_OUTCASTS, RACES_MANMADE, RACES_SECOND_CLASS, RACES_FEARED, RACES_WIDELY_REVILED, RACES_FAE)

#define RACES_OUTCAST_PLUS_FAE list(RACES_NOBILITY_ELIGIBLE, RACES_CHURCH_FAVORED, RACES_APPOINTED_OUTCASTS, RACES_FAE)
