...
/atom/movable/screen/alert/status_effect/passivity
	name = "Passive"
...
/atom/movable/screen/alert/status_effect/passivity/Click(location, control, params)
	if(!usr || !usr.client)
		return FALSE
	var/mob/user = usr
...
/datum/status_effect/passivity
	id = "passivity"
	alert_type = /atom/movable/screen/alert/status_effect/passivity
